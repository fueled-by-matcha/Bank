...
public class BankGUI {
    ...
    */
    private void doAddAccount() {
        // Request the name
        String customerFirstName = JOptionPane.showInputDialog("Enter Customer First Name");
        if (customerFirstName == null) 
            return; // Dialog was cancelled.
        String customerLastName = JOptionPane.showInputDialog("Enter Customer Last Name");
        if (customerFirstName == null) 
            return; // Dialog was cancelled.
        ...
        if (customerAddress == null)
            return;//Dialog was cancelled
        String customerPhoneNumber = JOptionPane.showInputDialog("Enter Customer Phone Number");
        ...
        String theNumber = theBank.addAccount(customerFirstName,customerLastName, customerAge,customerAddress,customerPhoneNumber,customerType, choice, VIP); 
        String message = null;
        message = "Account " + theNumber + " created for " +customerFirstName + " " +customerLastName;
    ...
    */
    private void doCheckAccount() {
       ...
       String theBalance = theBank.getAccount(accountNumber);
        String message = null;
        if (theBalance != null) { // Name was found.
